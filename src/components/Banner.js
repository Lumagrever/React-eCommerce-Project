  ...
  return (
    <div className='w-full h-auto overflow-x-hidden'>
        <div className='w-screen lg:h-[450px] xl:h-[550px] relative'>
          ...
          <div className="h-0 absolute w-full mx-auto flex justify-center bottom-8 lg:bottom-16 xl:bottom-20 gap-8">
          <div
            onClick={prevSlide}
            className="w-14 h-12 border-[1px] bg-black border-gray-700 flex items-center justify-center hover:cursor-pointer hover:bg-gray-700 hover:text-white active:bg-gray-900 duration-300"
          >
